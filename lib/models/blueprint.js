...
Blueprint.prototype._fileMapTokens = function(options) {
  var standardTokens = {
    __name__: function(options) {
      ...
      return options.locals.name || options.locals.entity.name;
    },
    __path__: function(options) {
      ...
      if (options.pod && options.hasPathToken) {
        return path.join(options.podPath, options.locals.name);
      }
    ...
    __test__: function(options) {
      ...
      return options.locals.name + '-test';
    }
  };
...
Blueprint.prototype.mapFile = function(file, locals) {
  var pattern, i;
  var fileMap = locals.fileMap || { __name__: options.locals.name };
