...
Blueprint.prototype._fileMapTokens = function(options) {
  var standardTokens = {
    __name__: function(options) {
      ...
      return options.locals.entity.name;
    },
    __path__: function(options) {
      ...
      if (options.pod && options.hasPathToken) {
        return path.join(options.podPath, options.locals.entity.name);
      }
    ...
    __test__: function(options) {
      ...
      return options.locals.entity.name + '-test';
    }
  };
...
Blueprint.prototype.isUpdate = function() {
  if (this.project && this.project.isMernCLIProject) {
    return this.project.isMernCLIProject();
  }
};
...
Blueprint.prototype.mapFile = function(file, locals) {
  var pattern, i;
  var fileMap = locals.fileMap || { __name__: options.locals.entity.name };
